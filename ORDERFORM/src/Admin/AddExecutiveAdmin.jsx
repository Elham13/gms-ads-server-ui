...
const AddExecutiveAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    switch (formData.role) {
      case 'executive':
        endpoint = 'http://localhost:5000/api/add-executive';
        break;
      case 'admin':
        endpoint = 'http://localhost:5000/api/add-admin';
        break;
      case 'designer':
        endpoint = 'http://localhost:5000/api/add-designer';
        break;
      case 'account':
        endpoint = 'http://localhost:5000/api/add-account';
        break;
      case 'Service Executive':
        endpoint = 'http://localhost:5000/api/add-service-executive';
        break;
      case 'Service Manager':
        endpoint = 'http://localhost:5000/api/add-service-manager';
        break;
      case 'Sales Manager':
        endpoint = 'http://localhost:5000/api/add-sales-manager';
        break;
      default:
    ...
    try {
      ...
      const capitalizedRole = formData.role.charAt(0).toUpperCase() + formData.role.slice(1);
      ...
      setPopupMessage('Error adding user: ' + (error.response ? error.response.data : error.message));
      setShowPopup(true);
    }
  };
