      ...
      <Routes>
        ...
        <Route path="/admin-dashboard" element={<AdminDashboard />}>
          <Route path="view-orders" element={<ViewOrders />} />
            ...
            <Route path="pending-payment" element={<PendingPayment/>} /> {/* ✅ NEW */}
            <Route path="pending-service" element={<PendingService/>} /> {/* ✅ NEW */}
            <Route path="appointments" element={<Appointment/>} /> {/* ✅ NEW */}
            <Route path="select-appointment" element={<SelectAppointment/>} /> {/* ✅ NEW */}
          
        </Route>
        <Route path="executive-dashboard" element={<ExecutiveDashboard/>} /> {/* ✅ NEW */}
        <Route path="pending-payment" element={<PendingPayment/>} /> {/* ✅ NEW */}
        <Route path="pending-service" element={<PendingService/>} /> {/* ✅ NEW */}
        <Route path="new-appointment" element={<NewAppointment/>} /> {/* ✅ NEW */}
